	...
	<div id="Abay_Content_Inner"> 
        <div id="Abay_Content">
        	<div class="section_w860">						
			 ...
			 <form name="" method="post" action="viewsearchvehicle.php" onsubmit="return checkform(this)">

<table width="450px">

<tr>
 <td>
 <font> <label for="Plate_No">Enter "PlateNo"</label>
 <input  type="text" name="PlateNo" maxlength="30" size="30">
