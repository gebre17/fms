 ...
 <table border=2px><tr><td>
	<form action="" method="POST">
	  <?php
								...
								?>
	<p style=font-size:30px;>Old Password:&nbsp;&nbsp;&nbsp;<input type="password" name="od" required></p>
    <p style=font-size:30px;>New Password:&nbsp;&nbsp;&nbsp;<input type="password" name="nw" required></p>
	<p style=font-size:30px;>Confirm Password:<input type="password" name="rt" required></p>
	<p style=font-size:30px;><center><input type="submit" value="Change" name="add">
