	...
	if(isset($_SESSION["User_Name"]))
	{
		...
		if(isset($_POST['add']))
		{
				...
				if($pass==$old && $new == $rety)
					...
					{
					$mss1="The two password not mach!!!";	
        ...
        <div id="Abay_Content">
        	<div class="section_w860">						
             <div class="section_w380r float_r"> 
					...
					<?php
													print"<h4><font color='green'>$msg </font></h4>";
													print"<h4><font color='red'>$msg1</font></h4>";
													print"<h4><font color='blue'>$mss1</font></h4>";

												?>
				<p  style=font-size:20px;>Old Password:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="password" name="od" placeholder="enter old password" required></p>
				<p  style=font-size:20px;>New Password:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="password" name="nw" placeholder="enter new password" required></p>
				<p  style=font-size:20px;>Confirm Password:<input type="password" name="rt" placeholder="confirm password" required></p>
					<center><input type="submit" value="Change" name="add">&nbsp;&nbsp;&nbsp;
...
<div id="templatemo_footer_wrapper">
   <div id="templatemo_footer">
		...
		<center><tr><td colspan="3"><div> <br/> &copy; All Right Reserved Bahirdar University Vehicle Managment Office</div></td></tr></center>
    </div> <!-- end of footer -->
</div>
