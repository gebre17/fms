	...
	if(isset($_SESSION["User_Name"]))
	{
		...
		if(isset($_POST['add']))
		{
				...
				if($pass==$old && $new == $rety)
					...
					{
					echo"the two password does not much!";
        	...
        	<div class="section_w860">						
             <div class="section_w380r float_r"> 
						<center><h2><u>Change Your Password</u></h2><center> 
						 <table border=4px><tr><td style=font-family:Times New Roman;  width=600px>
							<form action="" method="POST">
							
							<p style="font-size:20px">Old Password:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="password" name="ol" placeholder=" enter old password " required=""></p>
							<p style="font-size:20px">new Password:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="password" name="ne" placeholder=" enter new password " required=""></p>
							<p style="font-size:20px">confirm Password:<input type="password" name="re" placeholder=" confirm password" required=""></p>
							<p><center><input type="submit" value="Change" name="add">&nbsp;&nbsp;&nbsp;<input type="reset" value="Reset"><center></p>
							</form></td></tr></table>
