        ...
        <div id="Abay_Content">
        	<div class="section_w860">						
             <div class="section_w380r float_r"> 
					  ...
					  <center><table border=7px><tr><td style=font-family:Times New Roman; width=500px>
						...
						<p  style=font-size:20px;><input type="submit" value="Change" name="add">&nbsp;&nbsp;&nbsp;<input type="reset" value="Reset"></p><br/><br/>
